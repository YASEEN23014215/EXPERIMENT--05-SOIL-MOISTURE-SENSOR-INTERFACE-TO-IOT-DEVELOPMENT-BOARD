...
## Output screen shots on serial monitor   :
 ...
 <img width="1693" height="945" alt="Screenshot 2026-02-27 102418" src="https://github.com/user-attachments/assets/4c80b867-d2ec-4af7-92e8-dd1ffa516f96" />

 
 <img width="900" height="1600" alt="image" src="https://github.com/user-attachments/assets/e454f475-3ee2-40d5-924a-5e75746fecca" />

 
## Result :
Interfacing a Analog Input (soil moisture sensor) with ARM microcontroller based IOT development is executed and the results visualized on serial monito
